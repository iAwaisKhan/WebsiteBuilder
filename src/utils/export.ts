...
/**
 * Advanced Export Utility for CLOWN AI Website Builder
...
<head>
    ...
    <meta name="description" content="Website generated by CLOWN AI - The autonomous website builder.">
    <title>CLOWN AI | Built for Excellence</title>
...
<body class="min-h-screen">
  ...
  a.href = url;
  a.download = \`clown-site-\${Date.now()}.html\`;
